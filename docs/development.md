...
tests/         ~3,000 tests: routing, state machine, filters, phonetics, resilience
...
About 3,000 tests, ~90 s, no microphone or model required — the fakes are injectable precisely so
