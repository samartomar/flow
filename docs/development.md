...
tests/         ~3,100 tests: routing, state machine, filters, phonetics, resilience
...
About 3,100 tests, ~90 s, no microphone or model required — the fakes are injectable precisely so
