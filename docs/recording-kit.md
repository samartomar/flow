# Recording kit — send this page to the person recording
...
speaking. It works well for some accents and we do not yet know how well it works for
others — which is exactly what your recording tells us.

**Your recording stays on one laptop.** It is not uploaded anywhere, not used to train
...
2. Sit somewhere **normal** — a kitchen, an office, a room with a fan on. Please do
   **not** find a quiet studio, and please **do not** turn on any noise-removal
   setting. We need to know how it copes with real rooms.
...
Imagine you just dictated this message and it came out like this:
...
Send the file however is easiest — email, chat, a shared drive, anything.

**Any format your phone produces is fine.** `.m4a`, `.mp3`, `.wav`, `.opus` all work.
Do not convert it, do not trim it, do not clean it up.

Please also say **which language you grew up speaking** — that is the one piece of
information that makes the recording useful.

Thank you. This is the part of the work that cannot be done without people.
